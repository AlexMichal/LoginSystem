...
<section class="main_container">
    <div id="signup_main" class="main_wrapper">
        ...
        <form id="signup_form" class="form-group" action="includes/signup.inc.php" method="POST">
            <input type="text" name="first_name" placeholder="first name" class="input form-control" required>
            <input type="text" name="last_name" placeholder="last name" class="input form-control" required>
            <input type="text" name="email" placeholder="e-mail" class="input form-control" required>
